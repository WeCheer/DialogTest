package com.wyc.dialogsimple.base;
...
public class BaseViewHolder extends RecyclerView.ViewHolder {
     ...
     */
    public BaseViewHolder addOnClickListener(@IdRes final int viewId, final OnItemChildClickListener listener) {
        ...
        if (view != null) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (listener != null) {
                        listener.onItemChildClick(v, getAdapterPosition());
                    }
                }
            });
        }
     ...
     */
    public BaseViewHolder addOnLongClickListener(@IdRes final int viewId, final OnItemChildLongClickListener listener) {
        final View view = getView(viewId);
        if (view != null) {
            ...
            view.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    if (listener != null) {
                        return listener.onItemChildLongClick(v, getAdapterPosition());
                    }
                    return false;
                }
            });
